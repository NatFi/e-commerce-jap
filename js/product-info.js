...
function mostrarRelacionados(product){
...
function comentar(){
  ...
  let puntuacion = document.getElementById("valor").value;             //stars
  ...
  dejarcoment.score = puntuacion;  
  dejarcoment.dateTime = fechayhoracoment;


  if(dejarcoment.description.trim() !== "" ){
